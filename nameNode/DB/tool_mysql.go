...
const MysqlConfig = "root:123456@(127.0.0.1:3306)/test_db?charset=utf8mb4&parseTime=True&loc=Local"

func Test() {
	MysqlGenerate(MysqlConfig, "your_table_name", "your_table_name2") // 不传table_name默认生成全部数据表
}

func MysqlGenerate(sqlConf string, tables ...string) {
	// 连接数据库
